...
{i:2,k:"CS02b",d:"% of calls to Contact Centre answered within 30 seconds",n:"No notes",y:84.4,lq:85.8,tq:84.2,t:85,s:"la",u:"Customer Services",c:"f",p:"%"},
...
{i:5,k:"FI06",d:"% of undisputed invoices paid on time (old BVPI8)",n:"No notes",y:97.7,lq:98.2,tq:97.4,t:97,s:"lg",u:"Finance, Revs and Bens",c:"f",p:"%"},
{i:6,k:"HR01",d:"% accuracy in gross and net pay calculations for all payrolls",n:"No notes",y:100,lq:100,tq:98.7,t:98,s:"lg",u:"HR",c:"f",p:"%"},
...
{i:12,k:"HS07",d:"Preventing Homelessness - number of housing advice cases where homelessness prevented",n:"140702 - this figure may increase as we are not at the end of the month as yet. One of the Housing Options Officers leaves the Council on 11th July and this may impact further on our performance here.The continued implementation of more robust verification following Diagnostic Peer Review recommendations continues to keep preventions down.  Although prevention figure is lower - there were 131 clients seen for housing advice Apr to Jun 2014. The majority were not technically homeless or threatened with homelessness within the scope of reporting guidance and hence could not be recorded as 'prevention'. The Housing Needs Manager will  continue to monitor this.",y:365,lq:365,tq:36,t:36,s:"lg",u:"Housing Services",c:"f",p:""},
{i:13,k:"HS08",d:"% of private sector housing grant budgets actually spent (DFG) (Values are cumulative)",n:"24-June-2014 – To date this financial year £25k spent out of £500k budget (5%). £147k is committed but not yet paid and a potential £255k is at pre approval stage. ",y:57,lq:57,tq:5,t:15,s:"lr",u:"Housing Services",c:"f",p:"%"},
...
{i:16,k:"IA02",d:"Percentage of Audits carried out within time allocation",n:"No notes",y:94,lq:92,tq:100,t:100,s:"lg",u:"Audit",c:"f",p:"%"},
{i:17,k:"IA04",d:"% of High Risk Audit Recommendations Implemented",n:"No notes",y:100,lq:100,tq:100,t:100,s:"lg",u:"Audit",c:"f",p:"%"},
{i:18,k:"IT01",d:"% registered controllable incidents resolved at first point of contact",n:"No notes",y:51.6,lq:45.8,tq:42.5,t:60,s:"la",u:"IT Services",c:"f",p:"%"},
{i:19,k:"IT02",d:"% Priority 1 incidents fixed within 4 working hours",n:"No notes",y:94,lq:92.2,tq:100,t:90,s:"lg",u:"IT Services",c:"f",p:"%"},
{i:20,k:"IT03",d:"% Priority 2 incidents fixed within 8 working hours",n:"No notes",y:87.7,lq:92.3,tq:80.6,t:90,s:"lg",u:"IT Services",c:"f",p:"%"},
{i:21,k:"IT04",d:"% Priority 3 incidents fixed within 5 working days",n:"No notes",y:91.4,lq:88.2,tq:85.8,t:85,s:"lg",u:"IT Services",c:"f",p:"%"},
{i:22,k:"IT05",d:"% uptime of key systems",n:"No notes",y:98.9,lq:99.5,tq:99.9,t:99,s:"lg",u:"IT Services",c:"f",p:"%"},
{i:23,k:"IT06",d:"% uptime of Hart DC website",n:"No notes",y:100,lq:99.8,tq:99.6,t:98,s:"lg",u:"IT Services",c:"f",p:"%"},
{i:24,k:"IT07",d:"% score for Council employee satisfaction with Capita IT support service",n:"No notes",y:86,lq:81.2,tq:75.7,t:80,s:"la",u:"IT Services",c:"f",p:"%"},
{i:25,k:"LS05",d:"Summary of Projects status - Number of days ahead / behind project timetable",n:"ELC Project 4 weeks behind schedule but project construction Cost consultant / Clerk of works appointment is progressing. Expectation is that this period will be zeroed in Aug/Sept",y:0,lq:0,tq:-28,t:0,s:"lr",u:"Leisure Services",c:"f",p:""},
{i:26,k:"PS01",d:"Processing of planning applications: Major applications",n:"No notes",y:68.4,lq:75.2,tq:63.6,t:70,s:"la",u:"Planning Services",c:"f",p:"%"},
...
{i:28,k:"PS03",d:"Processing of planning applications: Other applications",n:"No notes",y:82.4,lq:69.6,tq:94.2,t:85,s:"lg",u:"Planning Services",c:"f",p:"%"},
...
{i:30,k:"RB01",d:"% of benefit assessments calculated correctly (new and change in circumstances)",n:"No notes",y:98.5,lq:97.2,tq:98.9,t:95,s:"lg",u:"Finance, Revs and Bens",c:"f",p:"%"},
{i:31,k:"RB02",d:"% of new benefit claims decided within 14 days",n:"No notes",y:98.8,lq:98.7,tq:95.6,t:90,s:"lg",u:"Finance, Revs and Bens",c:"f",p:"%"},
{i:32,k:"RB04",d:"% of council tax collected electronically (DD + Internet)",n:"No notes",y:85.1,lq:85.1,tq:83.9,t:80,s:"lg",u:"Finance, Revs and Bens",c:"f",p:"%"},
{i:33,k:"RB05",d:"Percentage of Non-domestic Rates Collected",n:"No notes",y:98.5,lq:98.5,tq:33.6,t:24.6,s:"lg",u:"Finance, Revs and Bens",c:"f",p:"%"},
{i:34,k:"RB06",d:"% of Council Tax collected",n:"No notes",y:98.7,lq:98.7,tq:30.5,t:24.5,s:"lg",u:"Finance, Revs and Bens",c:"f",p:"%"},
{i:35,k:"RB07",d:"Time taken to process Housing Benefit/Council Tax Benefit new claims.",n:"No notes",y:19.08,lq:19.85,tq:19.94,t:23,s:"lg",u:"Finance, Revs and Bens",c:"f",p:""},
...
{i:37,k:"RB09",d:"Time taken to process Housing Benefit/Council Tax Benefit new claims and change events",n:"No notes",y:9.1,lq:4.5,tq:9.4,t:12,s:"lg",u:"Finance, Revs and Bens",c:"f",p:""},
...
{i:39,k:"RS21",d:"% of incident responses carried out in prescribed time",n:"No notes",y:99.5,lq:100,tq:98.8,t:98,s:"lg",u:"Regulatory Services",c:"f",p:"%"},
{i:40,k:"SNH01",d:"% Reduction in Antisocial Behaviour across Safer North Hampshire area",n:"General increase in ASB across SNH area, in particular Hart.",y:16,lq:29,tq:0,t:3,s:"lr",u:"Safer North Hants",c:"f",p:"%"},
{i:41,k:"SNH02",d:"% Reduction in violence against the person offences with injury across Safer North Hampshire area",n:"Increase in violence against the person offences, both domestic and related to the Night Time Economy.",y:1,lq:2,tq:-16,t:5,s:"lr",u:"Safer North Hants",c:"f",p:"%"},
{i:42,k:"SNH03",d:"Number of Domestic Abuse incidents - domestic crimes",n:"No notes",y:1284,lq:283,tq:376,t:0,s:"ld",u:"Safer North Hants",c:"f",p:""},
{i:43,k:"SNH04",d:"Number of Domestic Abuse incidents - Violence against the person",n:"No notes",y:1035,lq:231,tq:169,t:0,s:"ld",u:"Safer North Hants",c:"f",p:""},
{i:44,k:"SNH06",d:"Drug Offences",n:"No notes",y:1238,lq:260,tq:271,t:0,s:"ld",u:"Safer North Hants",c:"f",p:""}
